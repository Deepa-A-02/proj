...
public class BookAppointmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ed1 = findViewById(R.id.editTextAppFullName2);
        ed2 = findViewById(R.id.editTextAppAddress2);
        ed3 = findViewById(R.id.editTextBMBPincode);
        ed4 = findViewById(R.id.editTextAppFees2);
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(BookAppointmentActivity.this, "Your Appointment Booked", Toast.LENGTH_SHORT).show();
            }
        });
    }
